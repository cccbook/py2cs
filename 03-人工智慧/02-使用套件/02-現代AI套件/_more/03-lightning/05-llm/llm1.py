...
class LitLLM(L.LightningModule):
    ...
    def on_train_start(self):
        state_dict = torch.load("checkpoints/meta-llama/Meta-Llama-3.2-1B/lit_model.pth", mmap=True)
...
if __name__ == "__main__":
    data = Alpaca2k()
    tokenizer = litgpt.Tokenizer("checkpoints/meta-llama/Meta-Llama-3.2-1B")
