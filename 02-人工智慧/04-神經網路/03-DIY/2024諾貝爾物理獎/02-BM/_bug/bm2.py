...
class BoltzmannMachine:
    def __init__(self, num_visible, num_hidden, regularization=0.0001):
        ...
        self.regularization = regularization  # L2 正則化項
    ...
    def train(self, data, learning_rate=0.01, epochs=1000, gibbs_steps=5):
        ...
        for epoch in range(epochs):
            ...
            for i in range(num_samples):
                ...
                # 權重更新時加入正則化項
                self.weights += learning_rate * (positive_gradient - negative_gradient - self.regularization * self.weights)
...
bm.train(training_data, learning_rate=0.01, epochs=100, gibbs_steps=5)
