...
class CharRNN(nn.Module):
    ...
    def __call__(self, x: mx.array, h: mx.array = None, training: bool = True) -> Tuple[mx.array, mx.array]:
        ...
        # RNN 前向傳播
        x = self.rnn(x)  # shape: (batch_size, sequence_length, hidden_size)
