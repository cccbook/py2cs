...
static PyNumberMethods Matrix_as_number = {
    ...
    Matrix_add,                    // nb_add
    0,                              // nb_subtract
    Matrix_mul,                    // nb_multiply
};

// 定義類型方法
static PyMethodDef Matrix_methods[] = {
    {"Matrix", (PyCFunction)Matrix_init, METH_O, "Create Matrix."},
    {"add", (PyCFunction)Matrix_add, METH_O, "Add two matrices."},
    {"mul", (PyCFunction)Matrix_mul, METH_O, "Multiply two matrices."},
